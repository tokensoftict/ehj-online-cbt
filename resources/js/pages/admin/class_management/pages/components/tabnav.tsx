...
const tabs = [
    { label: "Class Groups", href: "/admin/class-groups" },
    { label: "Class Names", href: "/admin/class-names" },
    { label: "Class Sections", href: "/admin/class-sections" },
    { label: "Student Classes", href: "/admin/student-classes" },
];
